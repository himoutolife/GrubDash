...
function orderExists(req, res, next) {//does the order exist validation
  ...
  function isIdValid(req, res, next) {//if the id is valid
  ...
  function isDeliverToValid(req, res, next) {//is the deliver to is valid
  ...
  function isStatusValid(req, res, next) {//is the order status valid
  ...
  function validateCreate(req, res, next) {//validating an order creation
  ...
  // CREATE
function create(req, res) {//create new order id
    ...
    //READ
    function read(req, res, next) {//if order id found, read data
    ...
    //UPDATE
    function update(req, res) {//update the found order data
      const orderId = req.params.orderId;
    ...
    //DESTROY
    function destroy(req, res, next) {//destroy the order id data only if its status is ONLY pending
      const orderId = req.params.orderId;
      const foundOrder = res.locals.order;
    ...
    // List
    function list(req, res) {//list the orders
